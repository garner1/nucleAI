...
size = int(sys.argv[1]) # sample size of patches
...
if numb_nuclei >= 100000:
    ...
    print('Generating the logarithmic descriptor')
    ...
    filename = dirpath+'/'+sample+'.nuclei'+str(numb_nuclei)+'.numbCovd'+str(size)+'.covdNN'+str(n_neighbors)+'.features.pkl'
